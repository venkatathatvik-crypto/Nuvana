...
const TeacherAttendance = () => {
  ...
  const submitAttendance = () => {
    ...
    toast.success(`Attendance submitted! ${presentCount}/${students.length} students present`);
  };
          ...
          <Card className="glass-card p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                <p className="text-sm text-muted-foreground mb-2">Present Today</p>
                <p className="text-4xl font-bold text-neon-cyan">{presentCount}/{students.length}</p>
              </div>
              <div className="text-center">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center font-bold ${
                        student.present ? "bg-neon-cyan/20 text-neon-cyan" : "bg-destructive/20 text-destructive"
                      }`}>
                        {student.rollNo}
                      </div>
                      <div>
                    ...
                    <div className="flex items-center gap-4">
                      <span className={`text-sm font-medium ${
                        student.present ? "text-neon-cyan" : "text-destructive"
                      }`}>
